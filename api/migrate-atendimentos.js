// api/atendimentos.js
// API REST para a tela de Atendimentos (Kanban) – versão robusta (sem SQL dinâmico perigoso)

import { neon, neonConfig } from '@neondatabase/serverless';
neonConfig.fetchConnectionCache = true;

// aceita vários nomes de variável de conexão (Vercel + Neon)
const DB_URL =
...
if (!DB_URL) throw new Error('Defina POSTGRES_URL/DATABASE_URL nas variáveis do Vercel.');
